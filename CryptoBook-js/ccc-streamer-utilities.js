...
CCC.STATIC.UTIL = {
  ...
  convertValueToDisplay: function(symbol, value,
    ...
    if (value < 0.00001000 && value >= 0.00000100 && decimalsOnSmallNumbers >
      3) {
      decimalsOnSmallNumbers = 3;
    }
    if (value < 0.00000100 && value >= 0.00000010 && decimalsOnSmallNumbers >
      2) {
    ...
    if (type == "short" || type == "8decimals") {
      if (valueAbs > 10000000000) {
        ...
        return prefix + filterNumberFunctionAngularJS(valueSign * valueAbs,
          decimalsOnBigNumbers) + ' B';
      }
      if (valueAbs > 10000000) {
        valueAbs = valueAbs / 1000000;
        return prefix + filterNumberFunctionAngularJS(valueSign * valueAbs,
          decimalsOnBigNumbers) + ' M';
      }
      if (valueAbs > 10000) {
        valueAbs = valueAbs / 1000;
        return prefix + filterNumberFunctionAngularJS(valueSign * valueAbs,
          decimalsOnBigNumbers) + ' K';
      }
...
CCC.filterNumberFunctionPolyfill = function(value, decimals) {
  ...
  var numberWithCorrectDecimals = Math.round(value * decimalsDenominator) /
    decimalsDenominator;
...
CCC.convertValueToDisplay = function(symbol, value, type, fullNumbers) {
  ...
  if (type == "short") {
    if (valueAbs > 10000000000) {
      valueAbs = valueAbs / 1000000000;
      return prefix + CCC.filterNumberFunctionPolyfill(valueSign * valueAbs,
        decimalsOnBigNumbers) + ' B';
    }
    if (valueAbs > 10000000) {
      valueAbs = valueAbs / 1000000;
    ...
    return prefix + CCC.noExponents((valueSign * valueAbs).toPrecision(
      decimalsOnSmallNumbers));
  }
};
...
CCC.UTILS.getSubscriptionFromMessage = function(message) {
...
CCC.UTILS.dataUnpackCurrent = function(message, currentPrice) {
  ...
  if (!currentPrice.hasOwnProperty(messageSubscription)) {
